...
import mcclogo from "../assets/latestnotificaton/mcclogo.jpg";
  ...
  <br />
      ...
      <div className="container">
        ...
        <div className="card" style={{ width: "25rem" }}>
          <div className="card-body">
            ...
            <img src={mcclogo} alt="Avatar" className="card-avatar" />
            <h6 className="card-subtitle mb-2 text-muted">
              Exam ⏰ july 28, 2023
            </h6>

            <p className="card-text">
            NEET PG 2023 Counselling Registration has been started at mcc.nic.in. Candidates can apply for the counselling process till August 1.
            </p>
      ...
      <div className="card" style={{ width: "25rem" }}>
        <div className="card-body">
          ...
          <p className="card-text">
          JoSAA Round 6 Cut Off 2023 for NITs, IIITs and GFTIs is available. Check JoSAA OR-CR Round 6 Cut Off, Qualifying Marks here.
          </p>
          <a href="#" className="card-button">
            Read more
          </a>
      ...
      <div className="card" style={{ width: "25rem" }}>
        <div className="card-body">
          <h5 className="card-title">
          Cluster University of Srinagar PG Admission 2023 Open,
          </h5>
          ...
          <p className="card-text">
          Cluster University of Srinagar, PG Admission 2023 Open, Apply till July 31,Cluster University of Srinagar PG Admission 2023 Open, Apply till July 31
          </p>
          <a href="#" className="card-button">
            Read more
          </a>
        ...
        <section className="featured-post container">
          ...
          <div className="card" style={{ width: "25rem" }}>
            <div className="card-body">
              <h5 className="card-title">
              JoSAA 2023 Round 6 Counselling Schedule Revised, Check Here
              </h5>
              <img src={mcc} alt="Avatar" className="card-avatar" />
              <h6 className="card-subtitle mb-2 text-muted">
                Exam ⏰ july 28, 2023
              ...
              <p className="card-text">
              JoSAA has revised the last date to respond to queries against Round 6 to July 29. Candidates can respond to queries at josaa.nic.in.
              </p>
              <a href="#" className="card-button">
                Read more
              </a>
            ...
            <div className="col-lg-4 col-md-4 col-sm-12 ">
              <div className="card" style={{ width: "25rem" }}>
                <div className="card-body">
                  <h5 className="card-title">
                  IIM Lucknow to Conduct CAT 2023, Read More
                  </h5>
                  ...
                  <p className="card-text">
                  IIM Lucknow is going to conduct CAT 2023. The official notification is expected to be released by July 31. Check details here.
                  </p>
                  <a href="#" className="card-button">
                    Read more
                  </a>
            ...
            <div className="col-lg-4 col-md-4 col-sm-12 ">
              <div className="card" style={{ width: "25rem" }}>
                <div className="card-body">
                  <h5 className="card-title">
                  MHT CET 2023 CAP Round 1 Cut Off Out, Check Here
                  </h5>
                  ...
                  <p className="card-text">
                  MHT CET 2023 CAP Round 1 Cut Off has been released at cetcell.mahacet.org. Candidates can check the cut off here, check details here.
                  </p>
                  <a href="#" className="card-button">
                    Read more
                  </a>
    ...
    <div className="jsx-1066289220 selected0-box selected0-box-lg bg-white rounded-lg h-100">
      ...
      <section className="jsx-2656711077 section-control mb-0 section-control-topgap">
        <div className="jsx-2656711077 container">
          <h2 className="jsx-2656711077 heading font-weight-bold top-course-title">Top Courses</h2>
          <MDBContainer>
      <MDBRow className='row-cols-2 row-cols-lg-5 g-2 g-lg-3'>
        ...
        >
          ...
          <svg
            ...
            className="ml-2 mt-1"
            viewBox="0 0 23 23"
            style={{ width: 23, height: 23, fill: "rgb(51, 51, 51)" }}
          >
            ...
            <div className="row mx-n2 col-md-8">
              ...
              <div className="jsx-2704726530 px-2 col-md-4">
                <div className="undefined ">
                  <label />
                  <select name="course_tag" className="input-style select-style">
                    {/* ... Options here ... */}
                  ...
                  <optgroup label="Bachelor">
                    ...
                    <option value={200}>B.F.Sc - Bachelor (Science)</option>
                    <option value={197}>
                      Bachelors (Animation &amp; Graphic Design) - Bachelor (Arts)
                    </option>
                    <option value={194}>B.P.Ed - Bachelor (Education)</option>
                    ...
                    <option value={19}>BHM - Bachelor (Hotel Management)</option>
                    <option value={2}>B.Com - Bachelors (Commerce)</option>
                    <option value={3}>B.Des - Bachelor (Design)</option>
                    <option value={4}>B.Ed - Bachelor (Education)</option>
                    <option value={5}>B.Pharm - Bachelor (Pharmacy)</option>
                    <option value={6}>B.Sc - Bachelors (Science)</option>
                    <option value={7}>
                    ...
                    <option value={12}>BA - Bachelors (Arts)</option>
                    <option value={13}>
                      Bachelors in Vocational Courses - Bachelor (Vocational
                      Courses)
                    </option>
                  ...
                  <optgroup label="Doctorate">
                    ...
                    <option value={97}>
                      M.Phil/Ph.D in Computer Applications - Doctorate (Computer
                      Applications)
                    </option>
                    <option value={98}>
                  ...
                  <optgroup label="Masters">
                    ...
                    <option value={192}>M.P.Ed - Masters (Education)</option>
                    <option value={191}>MHA - Masters (Management)</option>
                    ...
                    <option value={86}>M.Arch - Masters (Architecture)</option>
                    <option value={201}>M.F.Sc - Masters (Science)</option>
                    ...
                    <option value={199}>MMS - Masters (Management)</option>
                    <option value={91}>M.Pharm - Masters (Pharmacy)</option>
                    ...
                    <option value={125}>ME/M.Tech - Masters (Technology)</option>
                    <option value={126}>MHM - Masters (Hotel Management)</option>
                    <option value={127}>
